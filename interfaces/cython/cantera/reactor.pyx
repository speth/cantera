...
cdef class DelegatedReactor(Reactor):
    ...
    # def update_connected(self, update_pressure):
    #     self.reactor.updateConnected(update_pressure)

    # def get_surface_initial_conditions(self, double[:] y):
    #     self.reactor.getSurfaceInitialConditions(&y[0])
